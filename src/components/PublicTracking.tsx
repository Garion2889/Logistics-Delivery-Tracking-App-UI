...
const getLabel = (status: string) => {
  ...
  return labels[status] || status.replace(/_/g, " "); // Fallback: remove underscores
};
        ...
        <div className="text-center space-y-3">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-[#222B2D]/60">Track Your Delivery</p>
            </div>
          </div>
        </div>
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  ...
                  <Badge
                    ...
                    variant="outline"
                  >
                    {getLabel(delivery.status)} {/* Changed to use human label here too */}
                  </Badge>
                </div>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                ...
                >
                  ...
                  {delivery.driver?.last_lat && delivery.driver?.last_lng && (
                    <Marker
                      position={[
                        delivery.driver.last_lat,
                        delivery.driver.last_lng,
                      ]}
                      icon={defaultIcon}
                    >
                      <Popup>
                        ...
                        <br />
                        Status: {getLabel(delivery.driver.status)} {/* Human label here too */}
                        <br />
